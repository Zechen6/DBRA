...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        if args.resume_client_latest:
            if server.model_exists():
                server.load_model()
                print("[Resume] loaded server global model.")
            else:
                print("[Resume] server global model not found, skip loading global model.")

            server.resume_clients_from_latest(verbose=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume_client_latest',action='store_true',
            help='Load each client latest_model.pt before training')
