#Train CIFAR-100 classification models with Resnet18 or Resnet34.
import os
import argparse
import random
import numpy as np
...
def get_model(model_name, num_classes=100, cifar_stem=True):
    ...
    if model_name == "resnet18":
        ...
        raise ValueError(f"Unsupported Dataset: {model_name}")
...
def main():
    ...
    parser.add_argument("--no_cifar_stem", action="store_true", help="使用 torchvision 原版 ImageNet stem，不推荐 CIFAR100")
