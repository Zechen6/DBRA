...
def get_model(model_name, num_classes=10):
    ...
    # The original torchvision VGG is for ImageNet 1000 classes
    # Modify the classifier head according to the dataset's number of classes
